...
1.  How did you test that your implementation was correct?
   ...
   - Project has a swagger http://localhost:8080/doc/api/ - it possible to run query in swagger for manual checking.
2. If this application was destined for a production environment, what would you add or change? 
   - For business logic(functional):
     - Add filtration, and pagination for get payroll report endpoint
     - Add ability for change\remove downloaded data.
   - No functional:
     - Add logging storage, and set up storage for logging.
     - Add Authorization, divide access to endpoints by role, and tracking who made changes.

3. What compromises did you have to make as a result of the time constraints of this challenge?
   - Not full unit-test coverage.
